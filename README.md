<div align="center">
  <img src="./assets/banner.svg" alt="Simeet Nayan, software engineer, ML systems, open source" width="100%" />
</div>
...
After hours I work on **open-source machine learning**: training libraries, the systems around models, and on-device ML.
...
oss        ml-explore/mlx  |  ml-explore/mlx-examples  |  gmberton/awesome-machine-learning-startups
updated    2026-09-09 11:30 UTC
```
<!--END:IDENTITY-->
...
<!--START:FOOTER-->
<p align="center"><i>Dashboard last refreshed: Sep 09, 2026 11:30 UTC | stats cards and badges update on view | activity rewritten by <a href="./scripts/update_dashboard.py">scripts/update_dashboard.py</a></i></p>
<!--END:FOOTER-->
